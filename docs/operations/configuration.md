...
"configuration file" is typically a `scheduler.sh` shell script of the form.
    ...
    export JAVA_HOME=...
    export GLOG_v=1
    # Port and pulbic ip used to communicate with the Mesos master and for the replicated log
...
Both Mesos and Docker containerizer require configuration of the Mesos agent.
